...
public class main {
    ...
    public static void main(String[] args) {
        main a = new main();
        File in = new File("C:/Users/adm/Desktop/1lr/src/main.java");
        try {
            a.backOrderTheFile();
    ...
    private void backOrderTheFile() throws IOException {
        ...
        String str = readFile("C:/Users/adm/Desktop/1lr/src/main.java", charset);
        var tmpCharArray = str.toCharArray();
        StringBuilder tmp = new StringBuilder();
        for(var i = str.length()-1; i > 0; i--)
            tmp.append(tmpCharArray[i]);

        PrintWriter outputStream = new PrintWriter(new FileOutputStream("C:/Users/adm/Desktop/1lr/src/main1.java", false));
